...
- **Behavior Layer (Action Types & Rules)**: Dataset-level extension for executable semantics and governance rules. See `core-spec/behavior-layer.md` and `core-spec/behavior-layer.schema.json`.
